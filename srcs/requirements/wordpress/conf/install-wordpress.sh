...
if ! wp core is-installed --path=/wordpress --allow-root; then
    ...
    # Install WordPress
    wp core install --path=/wordpress --url="https://localhost" --title="docker-project" --admin_user="oumaima" --admin_password="ensa-1234" --admin_email="oumaimadaoudi13@gmail.com" --skip-email --allow-root
